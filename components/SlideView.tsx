...
/**
 * Tiny inline markdown-lite parser for closing-slide item values.
 * Supports **bold** and [text](url). Not a full markdown engine —
 * a link nested inside ** ** is not parsed (single-pass regex).
 */
